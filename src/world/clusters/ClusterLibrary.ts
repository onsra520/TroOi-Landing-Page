...
export type ModelKey = AssetId|'townhouse'|'shop'|'apartment'|'office'|'factory'|'landmark'|'gas-station';
...
function compose(kind:ClusterKind):Placement[] {
  ...
  switch(kind){
    ...
    case 'service': return [building('gas-station',-0.9,-0.8,1.4,1.7,1.7),building('building-d',0.95,-0.8,2.1,1.65,1.7),building('townhouse',-0.9,1,1.65,1.7,1.45),{...building('bush',1,1,0.9,1.2,1.2),role:'tree'}];
